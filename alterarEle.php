        ...
        <div class="interface"> <!-- Início da interface padrão de estilo para todos os sites -->
            ...
            <form method="post" action="alterarEle2.php"> <!-- Formulário para envio de dados com método POST -->
                ...
                <table class="tabela"> <!-- Início da tabela -->
                    ...
                    echo "<tr>  <th>Código</th> <th>Nome</th> <th>Sobrenome</th> <th>Telefone</th> <th>Cpf</th>
                     <th>Confirmar</th></tr>"; 
                    ...
                    while ($saida = mysqli_fetch_array($query)) {
                        ...
                        $telefone      = $saida[3]; // numero do candidato
                        $cpf           = $saida[4]; // partido do candidato 
                        ...
                        echo (" <td> <input class='alteracao' type='number' name='telefone' value='$telefone'> </input></td>"); // Campo numérico para numero
                        echo (" <td> <input class='alteracao' type='text' name='cpf' value='$cpf'> </input></td>"); // Campo de texto para partido
            ...
            <a class="voltar" href="consultaEle.php">CONSULTA</a> <!-- Botão para voltar para a página de consulta -->
